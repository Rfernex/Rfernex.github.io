...
* **Ongoing** : Project focused on analyzing patterns in the Bank of Japan's speeches using natural language processing (NLP) to identify linguistic and thematic indicators that predict decisions to raise, lower, or maintain key interest rate levels. **This project is done in R and Python**
